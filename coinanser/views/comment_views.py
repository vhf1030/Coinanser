...
from coinanser.forms import CommentForm
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('{}#answer_{}'.format(
                resolve_url('coinanser:detail', question_id=comment.question.id), comment.question.id))
    else:
        form = CommentForm()
    context = {'form': form}
...
def comment_create_answer(request, answer_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.save()
            return redirect('{}#answer_{}'.format(
                resolve_url('coinanser:detail', question_id=comment.answer.question.id), comment.answer.id))
    else:
        form = CommentForm()
    context = {'form': form}
    return render(request, 'coinanser/comment_form.html', context)
